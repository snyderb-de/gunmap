...
const scatterplot = () => new ScatterplotLayer({
    ...
    pickable: true,
    // bring in incident data from sourceData
    onHover: ({object, x, y}) => {
...
window.toggleModal = () => {
  ...
  // get the modal and the button and assign vars
  var modal = document.getElementById('gun-modal');
